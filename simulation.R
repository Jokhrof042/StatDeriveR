# ============================================
# STEP 5: Create R/simulation.R
# ============================================



# Create the simulation.R file
simulation_code <- '
...
# Write the file
writeLines(simulation_code, "R/simulation.R")

cat("✅ Created R/simulation.R\n")
cat("File location:", file.path(getwd(), "R/simulation.R"), "\n")
cat("File size:", file.size("R/simulation.R"), "bytes\n")

# Verify the file was created
if (file.exists("R/simulation.R")) {
  cat("\n✅ SUCCESS! File created and verified.\n")
  cat("\nFunctions created:\n")
  cat("  • simulate_check() - Main function (EXPORTED)\n")
  cat("  • .simulate_transform() - Simulate transformed variable\n")
  cat("  • .simulate_orderstat() - Simulate order statistic\n")
  cat("\nCapabilities:\n")
  cat("  ✓ Runs Monte Carlo simulations\n")
  cat("  ✓ Computes empirical moments\n")
  cat("  ✓ Computes theoretical moments (numerical integration)\n")
  cat("  ✓ Calculates absolute errors\n")
  cat("  ✓ Creates comparison table\n")
  cat("  ✓ Works with both transformations and order statistics\n")
  cat("  ✓ Handles infinite values gracefully\n")
} else {
