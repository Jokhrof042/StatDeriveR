# ============================================
# STEP 7: Create R/plot-methods.R
# ============================================



# Create the plot-methods.R file
plot_methods_code <- '
...
# Write the file
writeLines(plot_methods_code, "R/plot-methods.R")

cat("✅ Created R/plot-methods.R\n")
cat("File location:", file.path(getwd(), "R/plot-methods.R"), "\n")
cat("File size:", file.size("R/plot-methods.R"), "bytes\n")

# Verify the file was created
if (file.exists("R/plot-methods.R")) {
  cat("\n✅ SUCCESS! File created and verified.\n")
  cat("\nFunctions created:\n")
  cat("  • plot.statderive() - Main S3 plot method (EXPORTED)\n")
  cat("  • .plot_transform() - Plot transformation results\n")
  cat("  • .plot_orderstat() - Plot order statistic results\n")
  cat("\nPlot Features:\n")
  cat("  ✓ Histogram of simulated values\n")
  cat("  ✓ Theoretical PDF curve overlay\n")
  cat("  ✓ Professional formatting with titles\n")
  cat("  ✓ Legend showing both empirical and theoretical\n")
  cat("  ✓ Statistics box showing moments comparison\n")
  cat("  ✓ Works for both transformations and order statistics\n")
  cat("  ✓ Handles infinite support gracefully\n")
  cat("  ✓ Error handling for missing/invalid data\n")
} else {
