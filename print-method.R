# ============================================
# STEP 6: Create R/print-methods.R
# ============================================

# Make sure you're in the StatDeriveR directory
#setwd("~/Desktop/StatDeriveR")

# Create the print-methods.R file
print_methods_code <- '
...
# Write the file
writeLines(print_methods_code, "R/print-methods.R")

cat("✅ Created R/print-methods.R\n")
cat("File location:", file.path(getwd(), "R/print-methods.R"), "\n")
cat("File size:", file.size("R/print-methods.R"), "bytes\n")

# Verify the file was created
if (file.exists("R/print-methods.R")) {
  cat("\n✅ SUCCESS! File created and verified.\n")
  cat("\nFunctions created:\n")
  cat("  • print.statderive() - Main S3 print method (EXPORTED)\n")
  cat("  • .print_transform() - Print transformation derivation\n")
  cat("  • .print_orderstat() - Print order statistic derivation\n")
  cat("  • .print_simulation() - Print simulation results\n")
  cat("\nOutput Features:\n")
  cat("  ✓ Beautiful formatted headers\n")
  cat("  ✓ Problem statement\n")
  cat("  ✓ Mathematical assumptions\n")
  cat("  ✓ Step-by-step derivation\n")
  cat("  ✓ Support information\n")
  cat("  ✓ Final mathematical result\n")
  cat("  ✓ Simulation comparison table\n")
  cat("  ✓ Error metrics\n")
} else {
